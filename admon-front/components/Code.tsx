    ...
    return (
        <div className="bg-white flex flex-col p-5 md:p-6  border-2 border-palladium rounded-xl w-full sm:max-w-[440px]">
            <div className="flex justify-between">
                <div>
                    <h1 className='font-medium text-[22px] leading-[130%] md:mr-8'>Verifica tu telefono</h1>
                    <p className='text-slate-500 mt-2 text-base'>Se ha enviado un codigo SMS a tu numero de telefono</p>
                </div>
            </div>
            ...
            <div className="flex mt-4 gap-x-4">
                <button
                    onClick={() => void router.push('/selectdatabase')}
